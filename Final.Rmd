...
# sort. = TRUE puts the largest indices (biggest improvements) at the top
mod_indices <- modificationIndices(fit_path, sort. = TRUE)

# View the top 10 suggested modifications
head(mod_indices, 10)
